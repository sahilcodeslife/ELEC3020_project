...
#define SCAN_TURN_DURATION 300  // ms for each small turn (tune for ~15-20 degree sweep)
#define SCAN_PAUSE_DURATION 50  // ms pause to allow US sensor to update
#define MAX_SWAY_CYCLES 3  // Number of left/right oscillations in SEARCH_MODE before switching to FULL_SPIN_MODE
